...
constexpr auto PLUGIN_VERSION = "1.5.0-rc.1";
...
const int TAG_ITEM_CALCULATED_MACH_ABOVE_THRESHOLD = 7;
const int TAG_ITEM_CALCULATED_MACH_ABOVE_THRESHOLD_TOGGLABLE = 8;
...
const int TAG_FUNC_TOGGLE_CALCULATED_MACH_ABOVE_THRESHOLD = 107;
const int TAG_FUNC_TOGGLE_UNRELIABLE_SPEED = 108;
